...
(function() {
    ...
    PersonNotesEditorDialogController.$inject = ['$log', '$scope', '$state', '$rootScope', '$uibModalInstance', 'Note', 'personNoteEntity'];

    function PersonNotesEditorDialogController($log, $scope, $state, $rootScope, $uibModalInstance, Note, personNoteEntity) {
